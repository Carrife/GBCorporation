...
import { CreateForeignLanguageTest, Language, GetForeignLanguages } from "../../../Actions/ApplicantActions";
...
const ForeignLanguageTest = (props: {active: boolean, applicantId: string, setActive: (active: boolean) => void, token: string | null}) => {
    ...
    const onFinish = (values: any) => {
        CreateForeignLanguageTest(props.token, values, props.setActive, props.applicantId);
    };
    ...
    return (
        <ModalWindow title={ModalTitles.CREATE_FOREIGN_TEST} isActive={props.active} setActive={props.setActive}>
